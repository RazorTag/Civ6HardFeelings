...
local UV_CITIZEN_GROWTH_STATUS		:table	= {};
		UV_CITIZEN_GROWTH_STATUS[0] = {u=0, v=0};		-- depressed
		UV_CITIZEN_GROWTH_STATUS[1] = {u=0, v=50};		-- sad9
		UV_CITIZEN_GROWTH_STATUS[2] = {u=0, v=50};		-- sad8
		UV_CITIZEN_GROWTH_STATUS[3] = {u=0, v=50};		-- sad7
		UV_CITIZEN_GROWTH_STATUS[4] = {u=0, v=50};		-- sad6
		UV_CITIZEN_GROWTH_STATUS[5] = {u=0, v=50};		-- sad5
		UV_CITIZEN_GROWTH_STATUS[6] = {u=0, v=50};		-- sad4
		UV_CITIZEN_GROWTH_STATUS[7] = {u=0, v=50};		-- sad3
		UV_CITIZEN_GROWTH_STATUS[8] = {u=0, v=50};		-- sad2
		UV_CITIZEN_GROWTH_STATUS[9] = {u=0, v=50};		-- sad1
		UV_CITIZEN_GROWTH_STATUS[10] = {u=0, v=100};	-- content (normal)
		UV_CITIZEN_GROWTH_STATUS[11] = {u=0, v=150};	-- happy1
		UV_CITIZEN_GROWTH_STATUS[12] = {u=0, v=150};	-- happy2
		UV_CITIZEN_GROWTH_STATUS[13] = {u=0, v=150};	-- happy3
		UV_CITIZEN_GROWTH_STATUS[14] = {u=0, v=150};	-- happy4
		UV_CITIZEN_GROWTH_STATUS[15] = {u=0, v=150};	-- happy5
		UV_CITIZEN_GROWTH_STATUS[16] = {u=0, v=150};	-- happy6
		UV_CITIZEN_GROWTH_STATUS[17] = {u=0, v=150};	-- happy7
		UV_CITIZEN_GROWTH_STATUS[18] = {u=0, v=150};	-- happy8
		UV_CITIZEN_GROWTH_STATUS[19] = {u=0, v=150};	-- happy9
		UV_CITIZEN_GROWTH_STATUS[20] = {u=0, v=200};	-- ecstatic
